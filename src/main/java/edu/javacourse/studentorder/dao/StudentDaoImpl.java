...
public class StudentDaoImpl implements StudentOrderDao{
    ...
    public Long saveStudentOrder(StudentOrder so) throws DaoException {
        ...
        try (Connection con = getConnection();
            ...
            //добавление данных происходит в рамках одной транзакции
            //этой командой мы берем самостоятельный контроль над транзакцией
            ...
            try {
                ...
                // добавление данных в бд, возвращает количество добавленных данных (в данном случае 1)
                stmt.executeUpdate();
                ...
                con.commit(); // говорим, что транзакция прошла успешно
            }catch (SQLException ex) {
                con.rollback(); // откат изменений в БД
                throw ex;
            }
    ...
    private void saveChildren(Connection con, StudentOrder so, Long soId) throws SQLException {
        ...
        try(PreparedStatement stmt = con.prepareStatement(INSERT_CHILD)) {
            for (Child child : so.getChildren()) {
                ...
                stmt.addBatch();// накопление данных
            }
            stmt.executeBatch(); // помещение всех накопленных данных в бд
        }
    }
    ...
    private List<StudentOrder> getStudentOrdersOneSelect() throws DaoException {
        ...
        try (Connection con = getConnection();
             PreparedStatement stmt = con.prepareStatement(SELECT_FULL)) {
            ...
            while(rs.next()) {
                ...
                // проверка на поторение заявок, из за 2-х детей, получаемых сразу
    ...
    private Adult fillAdult(ResultSet rs, String pref) throws SQLException {
        ...
        adult.setDateOfBird(rs.getDate(pref + "date_of_birth").toLocalDate());
    ...
    private void findChildren(Connection con, List<StudentOrder> result) throws SQLException {
        ...
        //  поток значений из List<so> в виде целых чисел, преобразуем его в строку
