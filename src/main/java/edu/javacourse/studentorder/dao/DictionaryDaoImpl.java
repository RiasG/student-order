...
public class DictionaryDaoImpl implements DictionaryDao{
    ...
    public List<Street> findStreet(String pattern) throws DaoException {
        List<Street> res = new LinkedList<>();

        //эти параметры будут закрываться при окончании блока try, без необходимости это делать вручную
    ...
    public List<PassportOffice> findPassportOffices(String areaId) throws DaoException {
        List<PassportOffice> res = new LinkedList<>();
    ...
    public List<RegisterOffice> findRegisterOffices(String areaId) throws DaoException {
        List<RegisterOffice> res = new LinkedList<>();
    ...
    public List<CountryArea> findAreas(String areaId) throws DaoException {
        List<CountryArea> res = new LinkedList<>();
